...
class Application_Form_Rezervacije extends Zend_Form
{
    ...
    public function init() {
        ...
        $this->setDecorators(array(
            ...
            array('HtmlTag',array('tag'=>'table', 'width'=>'50%', 'cellspacing' => '0', 'cellpadding'=>'0')),
            'Form'
        ));
    ...
    array(array('row' => 'HtmlTag'), array('tag' => 'tr')),//napomena u drugom redu
        ...
        $submit->setAttribs(array('style' => 'margin:5px;', 'margin' => '10'));
